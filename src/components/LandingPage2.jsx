      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col image-section">
            <img src={pl1} alt="First Image" class="aspect-ratio-3-4" />
          </div>
        </div>
        <div class="row">
          <div class="col image-section">
            <img src={pl2} alt="Second Image" class="aspect-ratio-3-4" />
          </div>
          <div class="col text-section">
            <h1 className="landing-page-headings">
        ...
        <div class="row">
          ...
          <div class="col image-section">
            <img src={pl3} alt="Third Image" class="aspect-ratio-3-4" />
          </div>
        </div>
      </div>
    </div>
